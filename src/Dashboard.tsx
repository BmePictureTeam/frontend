...
export function Dashboard() {
  ...
  const renObjData = kategoriak.map(kategoria => {
    return (
      <tr className="paros">
        ...
        <td className="gombcella">
          ...
          />
          <button
            className="atvevezesGombok"
            onClick={() => atnevezKategoria(kategoria.id, name)}
          >
            Átnevez
          </button>
          <button
            className="torlesGombok"
